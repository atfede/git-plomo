...
class Googlemaps {
    ...
    var $map_height = "100%";//450px     // The height of the map container. Any units (ie 'px') can be used. If no units are provided 'px' will be presumed
    ...
    var $zoom = 14;//13       // The default zoom level of the map. If set to "auto" will autozoom/center to fit in all visible markers. If "auto", also overrides the $center parameter
        ...
        if ($this->center == "auto") { // if wanting to center on the users location
            $this->output_js_contents .= '
				...
				if(navigator.geolocation) {
					...
					}, function() {' . $this->map_name . '.setCenter(new google.maps.LatLng("-34.893997", "-56.155217"));  }); //alert("Unable to get your current position. Please try again. Geolocation service failed.");
