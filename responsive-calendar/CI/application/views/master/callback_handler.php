...
//header('Location: index.php'); // ok, si hay index.php en la raiz
//header('Location: http://proyectofinal.6te.net/index.php'); //ok, si hay index.php en la raiz
//header('Location: http://proyectofinal.6te.net/CI');
