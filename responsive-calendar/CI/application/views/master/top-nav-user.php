...
<div class="navbar navbar-blue navbar-static-top navbar_shadow">  
    ...
    <nav class="collapse navbar-collapse navbar_shadow" role="navigation">
        <form class="navbar-form navbar-left" action="../../controllers/UsuarioEdicionController.php">
            <div class="input-group input-group-sm" style="max-width:360px;">
                <input type="text" class="form-control" placeholder="Search" name="srch-term-user" id="srch-term-user">
...
//                }
                ?>" class="img-top" id="img_prof<?php // echo $_SESSION['ct']; ?>"/>

                <?php
                if (!isset($_SESSION["user"])) {
                    echo '<script type="text/javascript">document.getElementById("img_prof").style.display = "none";</script>';
                }
                ?>
            </li>
...
//        }
        ...
        <?php
        if (!isset($_SESSION["user"])) {
            echo '<a class="pull-right inicio_session" data-toggle="modal" data-target="#myModal" id="inicio_session">Iniciar sesión</a>';
        }
        ?>
        <!--</li>-->
    </nav>
