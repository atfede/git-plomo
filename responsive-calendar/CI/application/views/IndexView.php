...
<html lang="en">
    <head>
        <script type="text/javascript">
            ...
            //proyectofinal.6te.net
//            var oa = document.createElement('script');
//            oa.type = 'text/javascript';
//            oa.async = true;
//            oa.src = '//plomo.api.oneall.com/socialize/library.js'; ////proyectofinal.api.oneall.com/socialize/library.js
...
//            s.parentNode.insertBefore(oa, s);
            ...
            oa.type = 'text/javascript';
            oa.async = true;
            oa.src = '//plomo.api.oneall.com/socialize/library.js';
            var s = document.getElementsByTagName('script')[0];
            s.parentNode.insertBefore(oa, s);
    ...
    <body>
        ...
        <script type="text/javascript">
            var _oneall = _oneall || [];
            _oneall.push(['social_login', 'set_callback_uri', 'http://plomo.6te.net/callback_handler.php']);
