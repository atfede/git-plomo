...
<html>
    ...
    <body>
        <form id="filtro" action="RegistrarHoraController/registrar" method="post">  
            ...
            <input type="text" class="form-control" placeholder="Fecha" name="fecha" id="fecha" <!--value="<?//php echo $dia; ?>"-->>  
            <?php echo $select; ?>       
