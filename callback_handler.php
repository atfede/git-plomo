...
//Get connection_token
    ...
    //Your Site Settings
    $site_subdomain = 'plomo'; //proyectofinal
    $site_public_key = 'e6d78da3-ed48-41fd-b327-4f2a761f92cb';  //6823c942-3bec-44ba-a69d-6acbc86e5629
    $site_private_key = '3ee4070c-0ab4-4948-8e7f-2eead4065b66'; //f73581f3-6d95-4f5e-9fe6-8c3f7425e83d
...
//header('Location: http://proyectofinal.6te.net/CI/index.php/');
header('Location: http://plomo.6te.net/CI/index.php/');

//this->load->view("IndexView");

//redirect(base_url("IndexView")); //will redirect as you request
//site_url('/IndexController');

//$ci = get_instance();
//$ci->load->view('IndexController');
